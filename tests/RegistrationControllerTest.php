...
class RegistrationControllerTest extends WebTestCase
{
    ...
    protected function setUp(): void
    {
        ...
        $this->userRepository = $container->get(UsuarioRepository::class);
    ...
    public function testRegister(): void
    {
        ...
        self::assertEmailAddressContains($messages[0], 'from', 'sejama3@gmail.com');
        ...
        self::assertTrue(static::getContainer()->get(UsuarioRepository::class)->findAll()[0]->isVerified());
    }
}
